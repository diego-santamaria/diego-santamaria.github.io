...
I value integrity, ownership, and continuous learning. I prefer clarity over cleverness, and I aim to build systems that are maintainable, observable, and honest about their limitations.

I believe in measuring what matters, questioning assumptions, and choosing the simplest solution that solves the actual problem. I try to be direct and thoughtful, both in code and in communication.

## Why This Page Exists

This is not a blog. There is no content schedule, no newsletter, and no promise of regular updates.

This page exists so that I can be understood. It is a stable reference point for who I am and what I do. If I write something in the future, it will appear here, but only if and when I have something worth writing.

The site is intentionally minimal. It is complete as it is.

## Outside of Work

I enjoy photography, singing, and music.

I volunteer with [Asociación Alegría y Paz](https://alegriaypaz.org), a non-profit organization in Peru that supports educational development and opportunities for young people with limited resources.

## Find Me
On [GitHub](https://github.com/diego-santamaria) and [LinkedIn](https://linkedin.com/in/diego-santamaria-sotelo)
